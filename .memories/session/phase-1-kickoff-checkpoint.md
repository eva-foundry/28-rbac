...
# [28-rbac] Agent Wake-Up Checkpoint
...
## Authoritative Queries
    ...
    $project = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/projects/28-rbac"
    $projectWork = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/project_work/?project_id=28-rbac"
    $sprints = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/sprints/?project_id=28-rbac"
    $evidence = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/evidence/?project_id=28-rbac"
